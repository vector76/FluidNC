...
namespace MotorDrivers {
    ...
    void TMC5160Driver::set_registers(bool isHoming) {
        ...
        log_debug("CHOPCONF: " << to_hex(tmc5160->CHOPCONF()));
        log_debug("COOLCONF: " << to_hex(tmc5160->COOLCONF()));
        log_debug("THIGH: " << to_hex(tmc5160->THIGH()));
        log_debug("TCOOLTHRS: " << to_hex(tmc5160->TCOOLTHRS()));
        log_debug("GCONF: " << to_hex(tmc5160->GCONF()));
        log_debug("PWMCONF: " << to_hex(tmc5160->PWMCONF()));
        log_debug("IHOLD_IRUN: " << to_hex(tmc5160->IHOLD_IRUN()));
    }
